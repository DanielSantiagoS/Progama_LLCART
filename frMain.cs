...
namespace Forms_LLCART
{
    public partial class frmMain : Form
    {
        ...
        private void CarregarCozinha()
        {
            ...
            var label = new Label
            {
                Text = "Painel da Cozinha - Em Desenvolvimento",
                Dock = DockStyle.Fill,
                TextAlign = ContentAlignment.MiddleCenter,
                Font = new Font("Microsoft Sans Serif", 14, FontStyle.Bold),
                ForeColor = Color.Gray
        ...
        private void CarregarCaixa()
        {
            ...
            var label = new Label
            {
                Text = "Módulo do Caixa - Em Desenvolvimento",
                Dock = DockStyle.Fill,
                TextAlign = ContentAlignment.MiddleCenter,
                Font = new Font("Microsoft Sans Serif", 14, FontStyle.Bold),
                ForeColor = Color.Gray
        ...
        private void CarregarRelatorios()
        {
            ...
            var label = new Label
            {
                Text = "Módulo de Relatórios - Em Desenvolvimento",
                Dock = DockStyle.Fill,
                TextAlign = ContentAlignment.MiddleCenter,
                Font = new Font("Microsoft Sans Serif", 14, FontStyle.Bold),
                ForeColor = Color.Gray
